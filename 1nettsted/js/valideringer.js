...
function validerBestilling() {
	...
	var passasjertype = document.getElementById("passasjertype").value;
	var fraDato = document.getElementById("fraDato").value; //datepicker
	var tilDato = document.getElementById("tilDato").value; //datepicker
	var turRetur = document.getElementById("turRetur").value;
	var enVei = document.getElementById("enVei").value;

	if (turRetur != 0 || enVei != 2) {
		maaFyllesUt.push("Tur/retur eller En vei");
	}
