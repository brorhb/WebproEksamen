								...
								<div class="col-md-6">
									...
									<div class="col-md-6" style="margin-top:30px;">
										<div class="radio" name="reiseType" id="reiseType">
											<div class="col-md-6">
												<label>
													<input type="radio" name="reisevalg" id="turRetur" value="1" <?php if ($reisevalg=='1' ) { echo 'checked'; } ?> >Tur/Retur
												</label>
											</div>
											<div class="col-md-6">
												<label>
													<input type="radio" name="reisevalg" id="enVei" value="2" <?php if ($reisevalg=='2' ) { echo 'checked'; } ?> >En vei</label>
											</div>
										</div>
									</div>
								</div>
...
?>
							<tr>
								...
								<td>
									<?php echo $fraFlyplass; ?>
								</td>
								<td>
									<?php echo $avgang; ?>
								</td>
								<td>
									<?php echo $tilFlyplass; ?>
								</td>
								<td>
									<?php echo $avgang + $reiseTid ?>
								</td>
								<td>
									<input type="radio" name="id" value="<?php echo $flyvningNr; ?>">
								</td>
							</tr>
<?php
							}
