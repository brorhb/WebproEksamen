					 ...
					 <div class="container">
						  ...
						  <div class="navUtenJs">
							<ul>
								...
								<li><a href="allebestillinger.php">Alle bestillinger</a></li>
								<li><a href="allebrukere.php">Alle brukere</a></li>
								<li><a href="alleflyplasser.php">Alle flyplasser</a></li>
								<li><a href="valutta.php">Valuta</a></li>
								<li><a href="land.php">Land</a></li>
								<li><a href="alleklasser.php">Alle klasser</a></li>
								<li><a href="passasjertyper.php">Alle passasjertyper</a></li>
								<li><h2>Vi anbefaler at du har JavaScript aktiver når du bruker siden</h2></li>
							</ul>
						  </div>
						  <!-- /#sidebar uten JS -->
